    ...
    <View style={styles.container}>
      ...
      <View style={styles.controls}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          <TouchableOpacity onPress={() => setShowWeak(!showWeak)} style={[styles.chip, showWeak && styles.chipDanger]}>
          ...
          return (
            <View key={subject} style={styles.subjectCard}>
              <TouchableOpacity
                ...
                onPress={() => setExpanded(isExpanded ? null : subject)}
                activeOpacity={0.8}
              >
                  ...
                  {filtered.map((topic) => (
                    <View key={topic.id} style={styles.topicRow}>
                      ...
                      <View style={{ flex: 1, maxWidth: 160 }}>
                        <MasterySlider
                          value={topic.mastery}
                          onChange={(val) => updateMastery(topic.id, {
                            mastery: val,
