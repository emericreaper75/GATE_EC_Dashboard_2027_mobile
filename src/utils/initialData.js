...
// ── Pre-populated topic lists (from web app initialData.ts) ──────────────────

const PRE_POPULATED_TOPICS = {
  Networks: [
    'KVL/KCL & Mesh-Nodal',
    'Thevenin/Norton',
    'Two-port Parameters',
  ...
  'Signals & Systems': [
    ...
    'DTFT & DFT/IDFT',
    'Z-transform & ROC',
    'Convolution (Linear vs Circular)',
    'Sampling Theorem',
  ],
  ...
  Communications: [
    'AM Modulation & Bandwidth',
    "FM Modulation & Carson's Rule",
    'Digital Modulation (PSK/QAM/FSK)',
    'BER & SNR Expressions',
    'Shannon Capacity',
    'Noise Figure (Friis)',
  ],
...
export const INITIAL_MASTERY = Object.entries(PRE_POPULATED_TOPICS).flatMap(
  ([subject, topics]) =>
    topics.map((topic, i) => ({
...
export const INITIAL_TASKS = [
  ...
  {
    id: '2',
    title: 'Review combat formula sheet — Signals & Systems',
  ...
  {
    id: '3',
    title: 'Watch NPTEL lecture — Engineering Mathematics',
...
export const INITIAL_REMINDERS = [
  ...
  { id: 'r5', title: 'Phase Transition Alert', message: 'Phase 2 begins. No new concepts from today.', time: '08:00', repeat: 'one-time', active: false },
  { id: 'r6', title: 'Final Countdown', message: '7 days to GATE. Formulas only. Stay calm.', time: '08:00', repeat: 'one-time', active: false },
];
